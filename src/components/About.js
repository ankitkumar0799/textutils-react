...
export default function About(props) {
  ...
  <div className="accordion-item" >
    <h2 className="accordion-header" >
      <button className="accordion-button" type="button" style={{backgroundColor: props.mode==='dark'?'#042743':'white',color: props.mode==='dark'?'white':'#042743'}}   data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
        Text Utils Founder
      </button>
    </h2>
    <div id="collapseOne" className="accordion-collapse collapse show"  data-bs-parent="#accordionExample">
      ...
      © Copyright 2023, All Rights Reserved to <a href="https://github.com/ankitkumar0799">Github    </a>


      <a href="https://linkedin.com/in/ankit-kumar-aa11a2265">   linkedin</a>
